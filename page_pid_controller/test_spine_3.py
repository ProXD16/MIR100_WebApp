...
class GUI:
    ...
    def update_plot(self):
        ...
        if self.mpc_controller.spline is not None:
            ...
            y_spline = self.mpc_controller.spline(x_spline)  # Fixed: Use self.mpc_controller.spline
            ...
            lookahead_y = self.mpc_controller.spline(lookahead_x)  # Fixed: Use self.mpc_controller.spline
