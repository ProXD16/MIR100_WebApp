...
# from scipy.interpolate import CubicSpline  # No longer needed
...
class GUI:
    def __init__(self, master, mpc_controller):
        ...
        self.arc_plot, = self.ax_trajectory.plot([], [], 'g-', label="Arc", linewidth=2, zorder=2) # Replaced spline plot
        ...
        # Acceleration Tab (same as before)
    ...
    def update_plot(self):
        ...
        if self.mpc_controller.circle_center is not None and self.mpc_controller.circle_radius is not None:
            ...
            closest_angle = self.mpc_controller.find_closest_point_on_arc(x, y) #Get angle of closest point
            if closest_angle is not None:
                lookahead_angle = closest_angle + self.mpc_controller.lookahead_distance / self.mpc_controller.circle_radius  # s = r*theta --> theta = s/r
...
if __name__ == '__main__':
    ...
    # Updated to use /robot_pose with geometry_msgs/Pose
